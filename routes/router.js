...
const { getRegisterData,logout } = require("../controllers/Registration_Login/userControl");
...
const { generateCountry, cityRegioun} = require("../controllers/TimeZone_Convertor/controller");
const { getVerification } = require("../controllers/Registration_Login/verification");
const { authLogin } = require("../controllers/Registration_Login/authLogin");
const { forgotPass } = require("../controllers/Registration_Login/forgotPass");
const { rePassword } = require("../controllers/Registration_Login/rePassword");
const { updatePass } = require("../controllers/Registration_Login/updatePassword");

router.get("/", (req, res) => {
  res.render("Registration_Login/HomePage");
});

router.get("/register", (req, res) => {
  res.render("Registration_Login/RegistrationForm");
});
...
router.get("/login", (req, res) => {
  res.render("Registration_Login/LoginPage");
});
...
router.get( "/userDetails",
  ...
  (req, res) => {
    res.render("Registration_Login/userDetails", { data: req.user });
  }
);

router.get("/logout", logout);
router.get("/forgotpass", (req, res) => {
  res.render("Registration_Login/forgotPass");
});
...
router.get("/userDetails/validateMsg", authrate, (req, res) => {
  res.send(
    "Please Fill Required Field! OR Please Check emailID OR Please chaeck Phone Number"
  );
});
